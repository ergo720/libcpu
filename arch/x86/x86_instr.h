...
DECLARE_INSTR(INSTR_CMPXCHG8, "cmpxchg8")
...
DECLARE_INSTR(INSTR_LGDT, "lgdt")
DECLARE_INSTR(INSTR_LGS, "lgs")
DECLARE_INSTR(INSTR_LIDT, "lidt")
...
DECLARE_INSTR(INSTR_POPAD, "popad")
DECLARE_INSTR(INSTR_POPFD, "popfd")
DECLARE_INSTR(INSTR_PUSH, "push")
DECLARE_INSTR(INSTR_PUSHAD, "pushad")
DECLARE_INSTR(INSTR_PUSHFD, "pushfd")
