...
enum x86_instr_flags : uint64_t {
	...
	SRC_CR_REG		= (1ULL << 29),
	SRC_DBG_REG		= (1ULL << 30),
	SRC_MASK		= SRC_NONE|SRC_IMM_MASK|SRC_REL|SRC_REG|SRC_SEG2_REG|SRC_SEG3_REG|SRC_ACC|SRC_MEM|SRC_MOFFSET|SRC_MEM_DISP_BYTE|SRC_MEM_DISP_WORD|SRC_MEM_DISP_FULL|SRC_CR_REG|SRC_DBG_REG,
	...
	DST_CR_REG		= (1ULL << 41),
	DST_DBG_REG		= (1ULL << 42),
	DST_MASK		= DST_NONE|DST_IMM16|DST_REG|DST_ACC|DST_MEM|DST_MOFFSET|DST_MEM_DISP_BYTE|DST_MEM_DISP_WORD|DST_MEM_DISP_FULL|DST_SEG3_REG|DST_CR_REG|DST_DBG_REG,
